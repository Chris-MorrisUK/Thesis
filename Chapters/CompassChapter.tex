...
The project is also beneficial from the perspective of answering the questions set out in \autoref{ch:probstate}, since it allows the projects discussed in \autoref(ch:COMPASS) and \autoref{ch:middleware} to be considered in an industrial setting. 
